...
export const bookings: Booking[] = [
  { id: '1', salonName: 'Luxe Hair Studio', salonImage: salon1, services: ['Haircut & Styling', 'Beard Trim'], date: 'Mar 5, 2026', time: '10:30 AM', status: 'upcoming', totalPrice: 698, staffName: 'Priya S.' },
  { id: '2', salonName: 'Urban Glow', salonImage: salon3, services: ['Hair Spa'], date: 'Feb 20, 2026', time: '2:00 PM', status: 'completed', totalPrice: 799, staffName: 'Deepa L.', beforeImage: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=300&h=300&fit=crop' },
  { id: '3', salonName: 'The Royal Salon', salonImage: salon2, services: ['Facial', 'Hair Color'], date: 'Feb 10, 2026', time: '11:00 AM', status: 'cancelled', totalPrice: 2398, staffName: 'Rahul K.' },
];
