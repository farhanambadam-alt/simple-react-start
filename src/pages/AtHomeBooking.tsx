      ...
      <PageFloatingFooter>
        ...
        >
          <div className="max-w-lg mx-auto">
            ...
            {step === 'summary' && (
              <>
                <p className="text-[10.5px] text-center text-muted-foreground/80 font-body leading-relaxed px-2 mb-2">
                  By confirming, you agree to our{' '}
                  <button onClick={() => navigate('/terms')} className="text-foreground/90 underline underline-offset-2">Terms</button>,{' '}
                  <button onClick={() => navigate('/privacy')} className="text-foreground/90 underline underline-offset-2">Privacy</button>{' '}and{' '}
                  <button onClick={() => navigate('/refund-policy')} className="text-foreground/90 underline underline-offset-2">Refund Policy</button>.
                </p>
                <button
